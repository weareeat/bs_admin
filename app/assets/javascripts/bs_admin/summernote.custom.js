    ...
    var hHandleMousedown = function (event) {
      if (dom.isControlSizing(event.target)) {
        ...
        $editor.on('mousemove', function (event) {          
          ...
          // editor.resizeTo(event, posStart, $target);
      ...
      return '<div class="note-popover">' +
                ...
                '<div class="note-image-popover popover bottom in" style="display: none;">' +
                  ...
                  '<div class="popover-content note-image-content">' +
                    '<div class="btn-group">' +
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize 100%" data-event="resize" data-value="1" tabindex="-1"><span class="note-fontsize-10">100%</span> </button>' +
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize 75%" data-event="resize" data-value="0.75" tabindex="-1"><span class="note-fontsize-10">75%</span> </button>' +
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize 50%" data-event="resize" data-value="0.5" tabindex="-1"><span class="note-fontsize-10">50%</span> </button>' +
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize 25%" data-event="resize" data-value="0.25" tabindex="-1"><span class="note-fontsize-10">25%</span> </button>' +
                    '</div>' + 
                    '<div class="btn-group">' +
