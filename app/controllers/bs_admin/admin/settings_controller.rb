# -*- encoding : utf-8 -*-
class BsAdmin::Admin::SettingsController < AdminControllerBase
  def index
  ...
  def update    
    ...
    respond_to do |format|
      if setting.update_attributes(params["#{params[:type]}_setting"])
        ...
        setting.save!
        format.html { redirect_to bs_admin.admin_settings_group_path(params[:group_key]), notice: 'Setting was successfully updated.' }
      else
