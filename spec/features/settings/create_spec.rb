...
RSpec.describe "> create", type: :request do  
  before :all do    
    ...
    @c["group_1"] = BsAdmin::Settings.group :group_1, "Group 1", hint: "hint here" do |g|
      @c["subgroup_1"] = g.subgroup :subgroup_1, "Sub-Group 1", hint: "hint here" do |s|
        ...
        @c["subgroup_1_test_setting_2"] = s.string "Test Setting 2", :test_setting_2, "Test Value 2", hint: "hint here"
      end
    ...
    @c["group_2"] = BsAdmin::Settings.group :group_2, "Group 2", hint: "hint here" do |g|
